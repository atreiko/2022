...
const headerItems = document.querySelectorAll('.sr')

const SRItems = ScrollReveal({
  origin: 'left',
  distance: '60px',
  duration: 1500,
  delay: 1000
...
SRItems.reveal('.header__content-left')
// console.log(SRHeaderItems);
